...
public class OrderServiceImpl implements OrderService{
    ...
    @Override
    public void addMenuItemsInRestaurant(String restaurantName, String itemName, double price) {
    ...
    @Override
    public int placeOrder(List<String> items, OrderSelectionStrategy strategy) {
    ...
    public void completeOrder(int orderId) {
        ...
        if (order == null || order.getStatus() != OrderStatus.ACCEPTED) {
            throw new RuntimeException("Invalid order completion request.");
        }
